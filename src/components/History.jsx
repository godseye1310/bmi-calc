		...
		<Card className={"max-w-lg w-full mt-6 px-1"}>
			<div className="text-left">
				<h3 className="text-2xl text-neutral-300 mb-5 pl-3 flex justify-start items-center gap-x-3">
					...
					<button
						onClick={clear}
						className="text-neutral-100 px-3 pb-1 pt-1.5 text-sm font-extralight rounded-xs bg-sky-500 hover:bg-sky-600"
					>
						Clear
					</button>
				</h3>
